      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our icon system is designed to be clear, consistent, and scalable across all platforms.
          </p>
        </motion.div>
...
const guidelines = [
  {
    ...
    points: [
      'Use 24x24px as the base size for icons',
      'Maintain consistent stroke width (2px)',
      'Scale icons proportionally for different sizes',
    ],
  },
  {
    title: 'Usage',
